...
{
    uint8_t key8[1200] = "qwertyuiopasdfghjkqwertyuiopasdfghjkqwertyuiopasdfghjkqwertyuiopasdfghjkqwertyuiopasdfghjk";
    for (int i = 0; i <= 17; i++)
    {
        dinamic_keys[i] = static_keys[i] ^ (((uint32_t)key8[i] << 24) + ((uint32_t)key8[i + 1] << 16) + ((uint32_t)key8[i + 2] << 8) + (uint32_t)key8[i + 3]);
    }
    for (int i = 0; i <= 3; i++)
    {
        for (int j = 0; j <= 255; j++)
